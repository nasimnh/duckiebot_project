...
# Mask thresholds (HSV)
mask_lower_threshold = np.array([82, 44, 139])
mask_upper_threshold = np.array([96, 92, 187])
...
class LaneFollower:
	...
	#self.bound_sub = rospy.Subscriber('/darknet_ros/bounding_boxes', BoundingBoxes, self.image_callback)
	#self.object_count_sub = rospy.Subscriber('/darknet_ros/found_object', ObjectCount, self.object_count_callback)
	#self.bounding_sub = rospy.Subscriber('/darknet_ros/bounding_boxes', BoundingBoxes, self.bounding_callback)
